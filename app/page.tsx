...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Sin costo por crear anuncios. Solo pagas comisión al vender.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 text-primary mb-3">
              ...
              <p className="text-sm text-muted-foreground">Compra con confianza a vendedores verificados por La Segunda.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 text-primary mb-3">
              ...
              <p className="text-sm text-muted-foreground">Comunicación segura sin compartir datos personales.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 text-primary mb-3">
              ...
              <p className="text-sm text-muted-foreground">Sabés exactamente cuánto pagarás según tu plan.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 md:py-12 border-t bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Planes de membresía</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">Elige el plan que mejor se adapte a tus necesidades como vendedor.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Link href={isAuthenticated ? "/seller/membership" : "/auth/register"} className="w-full">
      ...
      <section className="py-8 md:py-12 border-t">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold mb-8">Por qué confiar en La Segunda</h2>
          ...
          <div className="bg-gradient-to-r from-secondary/10 to-accent/10 rounded-lg border border-secondary/20 p-8 md:p-12">
            <div className="max-w-3xl mx-auto">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-3">Chat protegido para comprador y vendedor</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href="#" className="hover:text-foreground">Cómo funciona</Link></li>
                <li><Link href="#" className="hover:text-foreground">Categorías</Link></li>
                <li><Link href="#" className="hover:text-foreground">Ofertas</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold mb-4">Vender</h3>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href="#" className="hover:text-foreground">Comenzar a vender</Link></li>
                <li><Link href="#" className="hover:text-foreground">Planes</Link></li>
                <li><Link href="#" className="hover:text-foreground">Soporte</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2024 La Segunda. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
